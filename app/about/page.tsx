...
import { ShieldCheck, Database, FileDown, CheckCircle2, ArrowRight, Github, Heart } from "lucide-react";
...
const features = [
  {
    ...
    title: "Privacy First",
    description: "Your data never leaves your device. No accounts, no tracking, no cloud databases."
  },
  {
    icon: <Database className="w-6 h-6 text-emerald-500" />,
    title: "Local Storage",
    description: "Habits are stored directly in your browser's local storage for instant access and total control."
  },
  {
    icon: <FileDown className="w-6 h-6 text-purple-500" />,
    title: "Excel Export",
    description: "Export your entire history to an Excel sheet anytime to prevent data loss or analyze your progress."
  }
];
    ...
    <div className="py-12 space-y-16 animate-fade-in">
      ...
      <section className="grid md:grid-cols-3 gap-6">
        {features.map((feature, idx) => (
          <Card key={idx} className="p-8 space-y-4 hover:border-slate-300 dark:hover:border-slate-700 transition-colors">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            <div className="flex gap-4">
              ...
              <div>
                <p className="font-semibold text-slate-900 dark:text-slate-100">Zero Data Collection</p>
                <p className="text-sm text-slate-600 dark:text-slate-400">We don't use cookies or analytics. What you do is your business.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="mt-1"><CheckCircle2 className="w-5 h-5 text-blue-500" /></div>
              <div>
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400">Since your data is local, we provide an "Export" feature so you can keep a permanent record in Excel format.</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="mt-1"><CheckCircle2 className="w-5 h-5 text-blue-500" /></div>
              <div>
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400">Built with Next.js for a seamless, lag-free experience on mobile and desktop.</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <div className="flex flex-col items-center gap-3">
    ...
    <div className="space-y-2">
      ...
      <p className="text-slate-600 dark:text-slate-400 max-w-md mx-auto leading-relaxed">
        I created Habitish to be a safe, private space for personal growth. 
        If it has helped you stay consistent, a star on GitHub would be the 
        best way to say thanks and help the project reach more people!
      </p>
    </div>
  </div>
